...
function StaffPinTerminal() {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[21rem] select-none"
    >
      ...
      <div className="mt-6 text-center">
        <Link
          href="/login"
          className="text-xs text-stone-500 transition-colors hover:text-gold-300"
        >
          Ma&apos;muriyat kirishi
        </Link>
      </div>
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0C0A09] px-5 py-12">
      ...
      <div className="relative flex w-full justify-center">
        <Suspense
          fallback={
            <div className="w-full max-w-[21rem] rounded-2xl border border-surface-border bg-surface-100/70 px-7 py-20 text-center text-xs text-stone-600 shadow-luxury">
              Yuklanmoqda…
            </div>
          }
        >
